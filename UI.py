...
class Table:
    def __init__(self, root, window):
        ...
        for i in range(len(headers)):
            ...
            self.e.grid(row=5, column=i, sticky ="nsew")
    ...
    def add_row(self, name, water, fert):
        ...
        delete= Button(self.root, text =  f'Delete {name}', command= lambda: self.popup_delete(row, name), font = ("Helvetica", "10", "bold"))
    ...
    def popup_delete(self, row, name):
        ...
        l = Label(popup, text=f'Are you sure to want to delete this plant, {name}? Click confirm to delete, and cancel to go back', font=("Helvetica", "9", "bold italic"))
        l.pack()
